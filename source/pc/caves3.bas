...
100 IF X = 0 THEN 270
110 PRINT
120 PRINT "   THIS GAME IS LIKE CAVES1 AND CAVES2 EXCEPT YOU"
130 PRINT "CAN SET UP THE CAVES ANY WAY YOU LIKE.  DIFFERENT"
140 PRINT "TUNNELS CAN LEAD TO THE SAME CAVERN, OR YOUR CAVERNS"
150 PRINT "CAN FORM LOOPS LIKE #12 - #13 - #19 - #12"
160 PRINT "(WARNING: NEVER TUNNEL BACK TO CAVERN # 1)"
170 PRINT "   EACH CAVERN HAS A NUMBER OF TUNNELS LEADING TO"
180 PRINT "OTHER CAVERNS - 0 TUNNELS MEANS A DEADEND CAVERN"
190 PRINT "OTHERWISE, YOU CAN HAVE 1,2,3,4 OR 5 TUNNELS"
200 PRINT
210 PRINT "   WHEN YOU'RE FINISHED, ASK A FRIEND TO FIND HIS WAY OUT"
220 PRINT
230 PRINT "   A GOOD IDEA IS TO MAKE A MAP AS YOU GO ALONG,"
240 PRINT "SO YOU CAN SEE WHAT YOUR CAVES LOOK LIKE"
250 PRINT
260 PRINT "   GOOD LUCK!"
270 V1 = 0
280 GOSUB 7500
...
330 PRINT "HOW MANY NEW TUNNELS";
340 INPUT X
...
1030 PRINT "NO FAIR;"; D1; "ISN'T A ROOM # !"
1040 GOTO 970
1050 W = D1
1060 D1 = 1
1070 V1 = 8
...
1170 X = 9999
1180 PRINT
1190 PRINT "YOU'RE IN CAVERN #"; N1
...
1550 PRINT
1560 PRINT "THIS SET OF CAVES AGAIN (1=YES, 0=NO)";
1570 INPUT X
1580 IF X = 1 THEN 1060
